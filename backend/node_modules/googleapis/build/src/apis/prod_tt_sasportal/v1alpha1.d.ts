...
export declare namespace prod_tt_sasportal_v1alpha1 {
    ...
    export class Resource$Customers {
         ...
         */
        checkHasProvisionedDeployment(params: Params$Resource$Customers$Checkhasprovisioneddeployment, options: StreamMethodOptions): GaxiosPromise<Readable>;
        checkHasProvisionedDeployment(params?: Params$Resource$Customers$Checkhasprovisioneddeployment, options?: MethodOptions): GaxiosPromise<Schema$SasPortalCheckHasProvisionedDeploymentResponse>;
        checkHasProvisionedDeployment(params: Params$Resource$Customers$Checkhasprovisioneddeployment, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        checkHasProvisionedDeployment(params: Params$Resource$Customers$Checkhasprovisioneddeployment, options: MethodOptions | BodyResponseCallback<Schema$SasPortalCheckHasProvisionedDeploymentResponse>, callback: BodyResponseCallback<Schema$SasPortalCheckHasProvisionedDeploymentResponse>): void;
        checkHasProvisionedDeployment(params: Params$Resource$Customers$Checkhasprovisioneddeployment, callback: BodyResponseCallback<Schema$SasPortalCheckHasProvisionedDeploymentResponse>): void;
        checkHasProvisionedDeployment(callback: BodyResponseCallback<Schema$SasPortalCheckHasProvisionedDeploymentResponse>): void;
        /**
    ...
    export interface Params$Resource$Customers$Checkhasprovisioneddeployment extends StandardParameters {
    }
