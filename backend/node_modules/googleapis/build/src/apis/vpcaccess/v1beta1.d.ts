...
export declare namespace vpcaccess_v1beta1 {
     ...
     * const vpcaccess = google.vpcaccess('v1beta1');
     * ```
     */
    ...
    export class Resource$Projects$Locations$Connectors {
        ...
        create(params?: Params$Resource$Projects$Locations$Connectors$Create, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
        ...
        delete(params?: Params$Resource$Projects$Locations$Connectors$Delete, options?: MethodOptions): GaxiosPromise<Schema$Operation>;
