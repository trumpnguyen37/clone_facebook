...
export declare namespace paymentsresellersubscription_v1 {
    ...
    export class Resource$Partners$Promotions {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        findEligible(params: Params$Resource$Partners$Promotions$Findeligible, options: StreamMethodOptions): GaxiosPromise<Readable>;
        findEligible(params?: Params$Resource$Partners$Promotions$Findeligible, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudPaymentsResellerSubscriptionV1FindEligiblePromotionsResponse>;
