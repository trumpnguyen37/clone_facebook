...
export declare namespace containeranalysis_v1beta1 {
    ...
    export class Resource$Projects$Notes {
         ...
         */
        batchCreate(params: Params$Resource$Projects$Notes$Batchcreate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        ...
        batchCreate(params: Params$Resource$Projects$Notes$Batchcreate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
    ...
    export class Resource$Projects$Occurrences {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchCreate(params: Params$Resource$Projects$Occurrences$Batchcreate, options: StreamMethodOptions): GaxiosPromise<Readable>;
        ...
        batchCreate(params: Params$Resource$Projects$Occurrences$Batchcreate, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
    ...
    export class Resource$Projects$Resources {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        exportSBOM(params: Params$Resource$Projects$Resources$Exportsbom, options: StreamMethodOptions): GaxiosPromise<Readable>;
        exportSBOM(params?: Params$Resource$Projects$Resources$Exportsbom, options?: MethodOptions): GaxiosPromise<Schema$ExportSBOMResponse>;
        exportSBOM(params: Params$Resource$Projects$Resources$Exportsbom, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        exportSBOM(params: Params$Resource$Projects$Resources$Exportsbom, options: MethodOptions | BodyResponseCallback<Schema$ExportSBOMResponse>, callback: BodyResponseCallback<Schema$ExportSBOMResponse>): void;
        exportSBOM(params: Params$Resource$Projects$Resources$Exportsbom, callback: BodyResponseCallback<Schema$ExportSBOMResponse>): void;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generatePackagesSummary(params: Params$Resource$Projects$Resources$Generatepackagessummary, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generatePackagesSummary(params?: Params$Resource$Projects$Resources$Generatepackagessummary, options?: MethodOptions): GaxiosPromise<Schema$PackagesSummaryResponse>;
        generatePackagesSummary(params: Params$Resource$Projects$Resources$Generatepackagessummary, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        generatePackagesSummary(params: Params$Resource$Projects$Resources$Generatepackagessummary, options: MethodOptions | BodyResponseCallback<Schema$PackagesSummaryResponse>, callback: BodyResponseCallback<Schema$PackagesSummaryResponse>): void;
        generatePackagesSummary(params: Params$Resource$Projects$Resources$Generatepackagessummary, callback: BodyResponseCallback<Schema$PackagesSummaryResponse>): void;
        generatePackagesSummary(callback: BodyResponseCallback<Schema$PackagesSummaryResponse>): void;
    }
    ...
    export interface Params$Resource$Projects$Resources$Generatepackagessummary extends StandardParameters {
        /**
