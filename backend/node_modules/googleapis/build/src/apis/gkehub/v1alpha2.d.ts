...
export declare namespace gkehub_v1alpha2 {
    ...
    export class Resource$Projects$Locations$Global$Memberships {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        initializeHub(params: Params$Resource$Projects$Locations$Global$Memberships$Initializehub, options: StreamMethodOptions): GaxiosPromise<Readable>;
        initializeHub(params?: Params$Resource$Projects$Locations$Global$Memberships$Initializehub, options?: MethodOptions): GaxiosPromise<Schema$InitializeHubResponse>;
