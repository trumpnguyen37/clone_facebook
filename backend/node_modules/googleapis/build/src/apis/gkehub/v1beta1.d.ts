...
export declare namespace gkehub_v1beta1 {
    ...
    export class Resource$Projects$Locations$Memberships {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        generateExclusivityManifest(params: Params$Resource$Projects$Locations$Memberships$Generateexclusivitymanifest, options: StreamMethodOptions): GaxiosPromise<Readable>;
        generateExclusivityManifest(params?: Params$Resource$Projects$Locations$Memberships$Generateexclusivitymanifest, options?: MethodOptions): GaxiosPromise<Schema$GenerateExclusivityManifestResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        validateExclusivity(params: Params$Resource$Projects$Locations$Memberships$Validateexclusivity, options: StreamMethodOptions): GaxiosPromise<Readable>;
        validateExclusivity(params?: Params$Resource$Projects$Locations$Memberships$Validateexclusivity, options?: MethodOptions): GaxiosPromise<Schema$ValidateExclusivityResponse>;
