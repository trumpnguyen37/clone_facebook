...
export declare namespace documentai_v1beta3 {
    ...
    export class Resource$Projects$Locations {
        ...
        fetchProcessorTypes(params?: Params$Resource$Projects$Locations$Fetchprocessortypes, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3FetchProcessorTypesResponse>;
    ...
    export class Resource$Projects$Locations$Processors {
        ...
        create(params?: Params$Resource$Projects$Locations$Processors$Create, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3Processor>;
        ...
        get(params?: Params$Resource$Projects$Locations$Processors$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3Processor>;
        ...
        list(params?: Params$Resource$Projects$Locations$Processors$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ListProcessorsResponse>;
        ...
        process(params?: Params$Resource$Projects$Locations$Processors$Process, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ProcessResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateDataset(params: Params$Resource$Projects$Locations$Processors$Updatedataset, options: StreamMethodOptions): GaxiosPromise<Readable>;
        updateDataset(params?: Params$Resource$Projects$Locations$Processors$Updatedataset, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
    ...
    export class Resource$Projects$Locations$Processors$Dataset {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchDeleteDocuments(params: Params$Resource$Projects$Locations$Processors$Dataset$Batchdeletedocuments, options: StreamMethodOptions): GaxiosPromise<Readable>;
        batchDeleteDocuments(params?: Params$Resource$Projects$Locations$Processors$Dataset$Batchdeletedocuments, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getDatasetSchema(params: Params$Resource$Projects$Locations$Processors$Dataset$Getdatasetschema, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getDatasetSchema(params?: Params$Resource$Projects$Locations$Processors$Dataset$Getdatasetschema, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3DatasetSchema>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        getDocument(params: Params$Resource$Projects$Locations$Processors$Dataset$Getdocument, options: StreamMethodOptions): GaxiosPromise<Readable>;
        getDocument(params?: Params$Resource$Projects$Locations$Processors$Dataset$Getdocument, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3GetDocumentResponse>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        importDocuments(params: Params$Resource$Projects$Locations$Processors$Dataset$Importdocuments, options: StreamMethodOptions): GaxiosPromise<Readable>;
        importDocuments(params?: Params$Resource$Projects$Locations$Processors$Dataset$Importdocuments, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        updateDatasetSchema(params: Params$Resource$Projects$Locations$Processors$Dataset$Updatedatasetschema, options: StreamMethodOptions): GaxiosPromise<Readable>;
        updateDatasetSchema(params?: Params$Resource$Projects$Locations$Processors$Dataset$Updatedatasetschema, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3DatasetSchema>;
    ...
    export class Resource$Projects$Locations$Processors$Processorversions {
        ...
        get(params?: Params$Resource$Projects$Locations$Processors$Processorversions$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ProcessorVersion>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        importProcessorVersion(params: Params$Resource$Projects$Locations$Processors$Processorversions$Importprocessorversion, options: StreamMethodOptions): GaxiosPromise<Readable>;
        importProcessorVersion(params?: Params$Resource$Projects$Locations$Processors$Processorversions$Importprocessorversion, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
        ...
        list(params?: Params$Resource$Projects$Locations$Processors$Processorversions$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ListProcessorVersionsResponse>;
        ...
        process(params?: Params$Resource$Projects$Locations$Processors$Processorversions$Process, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ProcessResponse>;
    ...
    export class Resource$Projects$Locations$Processors$Processorversions$Evaluations {
        ...
        get(params?: Params$Resource$Projects$Locations$Processors$Processorversions$Evaluations$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3Evaluation>;
        ...
        list(params?: Params$Resource$Projects$Locations$Processors$Processorversions$Evaluations$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ListEvaluationsResponse>;
    ...
    export class Resource$Projects$Locations$Processortypes {
        ...
        get(params?: Params$Resource$Projects$Locations$Processortypes$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ProcessorType>;
        ...
        list(params?: Params$Resource$Projects$Locations$Processortypes$List, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta3ListProcessorTypesResponse>;
