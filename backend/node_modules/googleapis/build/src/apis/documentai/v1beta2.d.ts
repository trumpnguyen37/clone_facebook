...
export declare namespace documentai_v1beta2 {
    ...
    export class Resource$Projects$Documents {
         ...
         */
        batchProcess(params: Params$Resource$Projects$Documents$Batchprocess, options: StreamMethodOptions): GaxiosPromise<Readable>;
        batchProcess(params?: Params$Resource$Projects$Documents$Batchprocess, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        process(params: Params$Resource$Projects$Documents$Process, options: StreamMethodOptions): GaxiosPromise<Readable>;
        process(params?: Params$Resource$Projects$Documents$Process, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta2Document>;
    ...
    export class Resource$Projects$Locations$Documents {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        batchProcess(params: Params$Resource$Projects$Locations$Documents$Batchprocess, options: StreamMethodOptions): GaxiosPromise<Readable>;
        batchProcess(params?: Params$Resource$Projects$Locations$Documents$Batchprocess, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunningOperation>;
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        process(params: Params$Resource$Projects$Locations$Documents$Process, options: StreamMethodOptions): GaxiosPromise<Readable>;
        process(params?: Params$Resource$Projects$Locations$Documents$Process, options?: MethodOptions): GaxiosPromise<Schema$GoogleCloudDocumentaiV1beta2Document>;
