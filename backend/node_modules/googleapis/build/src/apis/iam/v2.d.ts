...
export declare namespace iam_v2 {
    ...
    export class Resource$Policies {
        ...
        get(params?: Params$Resource$Policies$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleIamV2Policy>;
        ...
        get(params: Params$Resource$Policies$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleIamV2Policy>, callback: BodyResponseCallback<Schema$GoogleIamV2Policy>): void;
        get(params: Params$Resource$Policies$Get, callback: BodyResponseCallback<Schema$GoogleIamV2Policy>): void;
        ...
        listPolicies(params?: Params$Resource$Policies$Listpolicies, options?: MethodOptions): GaxiosPromise<Schema$GoogleIamV2ListPoliciesResponse>;
        ...
        listPolicies(params: Params$Resource$Policies$Listpolicies, options: MethodOptions | BodyResponseCallback<Schema$GoogleIamV2ListPoliciesResponse>, callback: BodyResponseCallback<Schema$GoogleIamV2ListPoliciesResponse>): void;
        listPolicies(params: Params$Resource$Policies$Listpolicies, callback: BodyResponseCallback<Schema$GoogleIamV2ListPoliciesResponse>): void;
        listPolicies(callback: BodyResponseCallback<Schema$GoogleIamV2ListPoliciesResponse>): void;
        /**
