...
export declare namespace vision_v1 {
    ...
    export class Resource$Projects$Locations$Files {
        ...
        annotate(params?: Params$Resource$Projects$Locations$Files$Annotate, options?: MethodOptions): GaxiosPromise<Schema$BatchAnnotateFilesResponse>;
    ...
    export class Resource$Projects$Locations$Images {
        ...
        annotate(params?: Params$Resource$Projects$Locations$Images$Annotate, options?: MethodOptions): GaxiosPromise<Schema$BatchAnnotateImagesResponse>;
    ...
    export class Resource$Projects$Locations$Productsets {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Productsets$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
    ...
    export class Resource$Projects$Locations$Productsets$Products {
         ...
         * @returns A promise if used with async/await, or void if used with a callback.
         */
        list(params: Params$Resource$Projects$Locations$Productsets$Products$List, options: StreamMethodOptions): GaxiosPromise<Readable>;
