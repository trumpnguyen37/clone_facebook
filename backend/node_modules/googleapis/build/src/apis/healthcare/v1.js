...
(function (healthcare_v1) {
    ...
    class Resource$Projects$Locations$Datasets$Fhirstores {
        ...
        getFHIRStoreMetrics(paramsOrCallback, optionsOrCallback, callback) {
            let params = (paramsOrCallback ||
                {});
            let options = (optionsOrCallback || {});
            if (typeof paramsOrCallback === 'function') {
            ...
            const parameters = {
                options: Object.assign({
                    url: (rootUrl + '/v1/{+name}:getFHIRStoreMetrics').replace(/([^:]\/)\/+/g, '$1'),
                    method: 'GET',
                }, options),
                params,
                requiredParams: ['name'],
...
})(healthcare_v1 || (exports.healthcare_v1 = healthcare_v1 = {}));
