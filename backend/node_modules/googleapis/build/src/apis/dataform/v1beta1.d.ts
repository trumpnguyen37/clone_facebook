...
export declare namespace dataform_v1beta1 {
    ...
    export class Resource$Projects$Locations$Repositories {
        ...
        commit(params?: Params$Resource$Projects$Locations$Repositories$Commit, options?: MethodOptions): GaxiosPromise<Schema$Empty>;
        ...
        commit(params: Params$Resource$Projects$Locations$Repositories$Commit, options: MethodOptions | BodyResponseCallback<Schema$Empty>, callback: BodyResponseCallback<Schema$Empty>): void;
        commit(params: Params$Resource$Projects$Locations$Repositories$Commit, callback: BodyResponseCallback<Schema$Empty>): void;
